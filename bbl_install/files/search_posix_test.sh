...
Add_Test 'KJV' 'search Jesus Christ --book romans in kjv' \
  'Romans 1:1 Paul, a servant of Jesus Christ, called [to be] an apostle, separated unto the gospel of God,' \
  'search' 'Jesus Christ' '--book' 'romans' 'in' 'kjv'
...
Add_Test 'RVR09' 'search Jesucristo --book romans in rvr09' \
  'Romanos 1:1 PABLO, siervo de Jesucristo, llamado á ser apóstol, apartado para el evangelio de Dios,' \
  'search' 'Jesucristo' '--book' 'romans' 'in' 'rvr09'

Add_Test 'RVR09' 'search Jesucristo in rvr09 --book romans --chapter 2' \
  'Romanos 2:16 En el día que juzgará el Señor lo encubierto de los hombres, conforme á mi evangelio, por Jesucristo.' \
  'search' 'Jesucristo' 'in' 'rvr09' '--book' 'romans' '--chapter' '2'

Add_Test 'RVR09' 'search Jesucristo in rvr09 --book romans --chapter 3 --end-chapter 5' \
  'Romanos 3:22 La justicia de Dios por la fe de Jesucristo, para todos los que creen en él: porque no hay diferencia;' \
  'search' 'Jesucristo' 'in' 'rvr09' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'TB' 'search Jesus Cristo --book romans in tb' \
  ...
  'search' 'Jesus Cristo' '--book' 'romans' 'in' 'tb'

Add_Test 'TB' 'search Jesus Cristo in tb --book romans --chapter 3 --end-chapter 5' \
  'Romanos 3:22 a saber, a justiça de Deus mediante a fé em Jesus Cristo, para com todos os que creem. Pois não há distinção,' \
  'search' 'Jesus Cristo' 'in' 'tb' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'DELUT' 'search Jesu Christi --book romans in delut' "$(cat <<'EOT'
Römer 1:1 Paulus, ein Knecht Jesu Christi, berufen zum Apostel, ausgesondert, zu predigen das Evangelium Gottes,
EOT
)" 'search' 'Jesu Christi' '--book' 'romans' 'in' 'delut'

Add_Test 'DELUT' 'search Jesu Christi in delut --book romans --chapter 2' "$(cat <<'EOT'
Römer 2:16 auf den Tag, da Gott das Verborgene der Menschen durch Jesus Christus richten wird laut meines Evangeliums.
EOT
)" 'search' 'Jesu Christi' 'in' 'delut' '--book' 'romans' '--chapter' '2'

Add_Test 'DELUT' 'search Jesu Christi in delut --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
...
EOT
)" 'search' 'Jesu Christi' 'in' 'delut' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'LSG' 'search Jésus-Christ --book romans in lsg' "$(cat <<'EOT'
Romains 1:1 Paul, serviteur de Jésus-Christ, appelé à être apôtre, mis à part pour annoncer l’Évangile de Dieu,
EOT
)" 'search' 'Jésus-Christ' '--book' 'romans' 'in' 'lsg'

Add_Test 'LSG' 'search Jésus-Christ in lsg --book romans --chapter 2' "$(cat <<'EOT'
...
EOT
)" 'search' 'Jésus-Christ' 'in' 'lsg' '--book' 'romans' '--chapter' '2'

Add_Test 'LSG' 'search Jésus-Christ in lsg --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
Romains 3:22 justice de Dieu par la foi en Jésus-Christ pour tous ceux qui croient. Il n’y a point de distinction.
EOT
)" 'search' 'Jésus-Christ' 'in' 'lsg' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'SINOD' 'search Иисуса Христа --book romans in sinod' "$(cat <<'EOT'
Послание к Римлянам 1:1 Павел, раб Иисуса Христа, призванный Апостол, избранный к благовестию Божию,
EOT
)" 'search' 'Иисуса Христа' '--book' 'romans' 'in' 'sinod'
Add_Test 'SINOD' 'search Иисуса Христа in sinod --book romans --chapter 2' "$(cat <<'EOT'
...
EOT
)" 'search' 'Иисуса Христа' 'in' 'sinod' '--book' 'romans' '--chapter' '2'
Add_Test 'SINOD' 'search Иисуса Христа in sinod --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
Послание к Римлянам 3:22 правда Божия через веру в Иисуса Христа во всех и на всех верующих, ибо нет различия,
EOT
)" 'search' 'Иисуса Христа' 'in' 'sinod' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'SVRJ' 'search JEZUS CHRISTUS --book romans in svrj' "$(cat <<'EOT'
ROMEINEN 1:1 Paulus, een dienstknecht van Jezus Christus, een geroepen apostel, afgezonderd tot het Evangelie van God,
EOT
)" 'search' 'JEZUS CHRISTUS' '--book' 'romans' 'in' 'svrj'
Add_Test 'SVRJ' 'search JEZUS CHRISTUS in svrj --book romans --chapter 2' "$(cat <<'EOT'
...
EOT
)" 'search' 'JEZUS CHRISTUS' 'in' 'svrj' '--book' 'romans' '--chapter' '2'
Add_Test 'SVRJ' 'search JEZUS CHRISTUS in svrj --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
...
EOT
)" 'search' 'JEZUS CHRISTUS' 'in' 'svrj' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
EOT
)" 'search' 'Gesù Cristo' '--book' 'romans' 'in' 'rdv24'
Add_Test 'RDV24' 'search Gesù Cristo in rdv24 --book romans --chapter 2' "$(cat <<'EOT'
...
Add_Test 'UBG' 'search Jezusa Chrystusa --book romans in ubg' "$(cat <<'EOT'
Rzymian 1:1 Paweł, sługa Jezusa Chrystusa, powołany apostoł, odłączony do głoszenia ewangelii Boga;
EOT
)" 'search' 'Jezusa Chrystusa' '--book' 'romans' 'in' 'ubg'
Add_Test 'UBG' 'search Jezusa Chrystusa in ubg --book romans --chapter 2' "$(cat <<'EOT'
Rzymian 2:16 W dniu, w którym Bóg przez Jezusa Chrystusa będzie sądził skryte sprawy ludzkie według mojej ewangelii.
EOT
)" 'search' 'Jezusa Chrystusa' 'in' 'ubg' '--book' 'romans' '--chapter' '2'
Add_Test 'UBG' 'search Jezusa Chrystusa in ubg --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
...
EOT
)" 'search' 'Jezusa Chrystusa' 'in' 'ubg' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'UBIO' 'search Ісуса Христа --book romans in ubio' "$(cat <<'EOT'
До римлян 1:1 Павло, раб Ісуса Христа, покликаний апостол, вибраний для звіщання Євангелії Божої,
EOT
)" 'search' 'Ісуса Христа' '--book' 'romans' 'in' 'ubio'
Add_Test 'UBIO' 'search Ісуса Христа in ubio --book romans --chapter 2' "$(cat <<'EOT'
До римлян 2:16 дня, коли Бог, згідно з моїм благовістям, буде судити таємні речі людей через Ісуса Христа.
EOT
)" 'search' 'Ісуса Христа' 'in' 'ubio' '--book' 'romans' '--chapter' '2'
Add_Test 'UBIO' 'search Ісуса Христа in ubio --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
До римлян 3:22 А Божа правда через віру в Ісуса Христа в усіх і на всіх, хто вірує, бо різниці немає,
EOT
)" 'search' 'Ісуса Христа' 'in' 'ubio' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'SVEN' 'search Jesu Kristi --book romans in sven' "$(cat <<'EOT'
Romarbrevet 1:1 Paulus, Jesu Kristi tjänare, kallad till apostel, avskild till att förkunna Guds evangelium,
EOT
)" 'search' 'Jesu Kristi' '--book' 'romans' 'in' 'sven'
Add_Test 'SVEN' 'search Jesu Kristi in sven --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
Romarbrevet 3:22 en rättfärdighet från Gud genom tro på Jesus Kristus, för alla dem som tro. Ty här är ingen åtskillnad.
EOT
)" 'search' 'Jesu Kristi' 'in' 'sven' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'CUNP' 'search 耶稣基督 --book romans in cunp' "$(cat <<'EOT'
罗马书 1:1 耶稣基督的仆人 保罗 ，奉召为使徒，特派传　神的福音。
EOT
)" 'search' '耶稣基督' '--book' 'romans' 'in' 'cunp'
Add_Test 'CUNP' 'search 耶稣基督 in cunp --book romans --chapter 2' "$(cat <<'EOT'
罗马书 2:16 就在　神藉耶稣基督审判人隐秘事的日子，照着我的福音所言。
EOT
)" 'search' '耶稣基督' 'in' 'cunp' '--book' 'romans' '--chapter' '2'
Add_Test 'CUNP' 'search 耶稣基督 in cunp --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
罗马书 3:22 就是　神的义，因信耶稣基督加给一切相信的人，并没有分别。
EOT
)" 'search' '耶稣基督' 'in' 'cunp' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'KRV' 'search 예수그리스도 --book romans in krv' "$(cat <<'EOT'
로마서 1:1 예수 그리스도의 종 바울은 사도로 부르심을 받아 하나님의 복음을 위하여 택정함을 입었으니
EOT
)" 'search' '예수그리스도' '--book' 'romans' 'in' 'krv'
Add_Test 'KRV' 'search 예수그리스도 in krv --book romans --chapter 2' "$(cat <<'EOT'
로마서 2:16 곧 내 복음에 이른 바와 같이 하나님이 예수 그리스도로 말미암아 사람들의 은밀한 것을 심판하시는 그날이라
EOT
)" 'search' '예수그리스도' 'in' 'krv' '--book' 'romans' '--chapter' '2'
Add_Test 'KRV' 'search 예수그리스도 in krv --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
로마서 3:22 곧 예수 그리스도를 믿음으로 말미암아 모든 믿는 자에게 미치는 하나님의 의니 차별이 없느니라
EOT
)" 'search' '예수그리스도' 'in' 'krv' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'JC' 'search イエス・キリスト --book romans in jc' "$(cat <<'EOT'
ローマ人への手紙 1:1 キリスト・イエスの僕、神の福音のために選び別たれ、召されて使徒となったパウロから-
EOT
)" 'search' 'イエス・キリスト' '--book' 'romans' 'in' 'jc'
Add_Test 'JC' 'search イエス・キリスト in jc --book romans --chapter 2' "$(cat <<'EOT'
ローマ人への手紙 2:16 そして、これらのことは、わたしの福音によれば、神がキリスト・イエスによって人々の隠れた事がらをさばかれるその日に、明らかにされるであろう。
EOT
)" 'search' 'イエス・キリスト' 'in' 'jc' '--book' 'romans' '--chapter' '2'
Add_Test 'JC' 'search イエス・キリスト in jc --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
ローマ人への手紙 3:22 それは、イエス・キリストを信じる信仰による神の義であって、すべて信じる人に与えられるものである。そこにはなんらの差別もない。
EOT
)" 'search' 'イエス・キリスト' 'in' 'jc' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'AYT' 'search Yesus Kristus --book romans in ayt' "$(cat <<'EOT'
Roma 1:1 Paulus, hamba Yesus Kristus, yang dipanggil menjadi rasul dan dikhususkan bagi Injil Allah;
EOT
)" 'search' 'Yesus Kristus' '--book' 'romans' 'in' 'ayt'
Add_Test 'AYT' 'search Yesus Kristus in ayt --book romans --chapter 2' "$(cat <<'EOT'
...
EOT
)" 'search' 'Yesus Kristus' 'in' 'ayt' '--book' 'romans' '--chapter' '2'
Add_Test 'AYT' 'search Yesus Kristus in ayt --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
Roma 3:24 dan dibenarkan dengan cuma-cuma oleh kasih karunia-Nya melalui penebusan yang ada dalam Yesus Kristus;
EOT
)" 'search' 'Yesus Kristus' 'in' 'ayt' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'TH1971' 'search พระเยซูคริสต์ --book romans in th1971' "$(cat <<'EOT'
...
EOT
)" 'search' 'พระเยซูคริสต์' '--book' 'romans' 'in' 'th1971'
Add_Test 'TH1971' 'search พระเยซูคริสต์ in th1971 --book romans --chapter 2' "$(cat <<'EOT'
โรม 2:16 ในวันที่พระเจ้าทรงพิพากษาความลับของมนุษย์โดยพระเยซูคริสต์ ทั้งนี้ตามข่าวประเสริฐที่ข้าพเจ้าได้ประกาศนั้น
EOT
)" 'search' 'พระเยซูคริสต์' 'in' 'th1971' '--book' 'romans' '--chapter' '2'
Add_Test 'TH1971' 'search พระเยซูคริสต์ in th1971 --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
โรม 3:22 คือความชอบธรรมของพระเจ้า ซึ่งทรงประทานโดยความเชื่อในพระเยซูคริสต์ แก่ทุกคนที่เชื่อ เพราะว่าคนทั้งหลายไม่ต่างกัน
EOT
)" 'search' 'พระเยซูคริสต์' 'in' 'th1971' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'IRVHIN' 'search यीशु मसीह --book romans in irvhin' "$(cat <<'EOT'
...
EOT
)" 'search' 'यीशु मसीह' '--book' 'romans' 'in' 'irvhin'
Add_Test 'IRVHIN' 'search यीशु मसीह in irvhin --book romans --chapter 2' "$(cat <<'EOT'
रोमियों 2:16 जिस दिन परमेश्वर मेरे सुसमाचार के अनुसार यीशु मसीह के द्वारा मनुष्यों की गुप्त बातों का न्याय करेगा।
EOT
)" 'search' 'यीशु मसीह' 'in' 'irvhin' '--book' 'romans' '--chapter' '2'
Add_Test 'IRVHIN' 'search यीशु मसीह in irvhin --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
...
EOT
)" 'search' 'यीशु मसीह' 'in' 'irvhin' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'IRVBEN' 'search যীশু খ্রীষ্ট --book romans in irvben' "$(cat <<'EOT'
...
EOT
)" 'search' 'যীশু খ্রীষ্ট' '--book' 'romans' 'in' 'irvben'
Add_Test 'IRVBEN' 'search যীশু খ্রীষ্ট in irvben --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
...
EOT
)" 'search' 'যীশু খ্রীষ্ট' 'in' 'irvben' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'IRVTAM' 'search இயேசுகிறிஸ்து --book romans in irvtam' "$(cat <<'EOT'
...
EOT
)" 'search' 'இயேசுகிறிஸ்து' '--book' 'romans' 'in' 'irvtam'
Add_Test 'IRVTAM' 'search இயேசுகிறிஸ்து in irvtam --book romans --chapter 2' "$(cat <<'EOT'
...
EOT
)" 'search' 'இயேசுகிறிஸ்து' 'in' 'irvtam' '--book' 'romans' '--chapter' '2'
Add_Test 'IRVTAM' 'search இயேசுகிறிஸ்து in irvtam --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
...
EOT
)" 'search' 'இயேசுகிறிஸ்து' 'in' 'irvtam' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'NPIULB' 'search येशू ख्रीष्‍ट --book romans in npiulb' "$(cat <<'EOT'
रोमी 1:1 प्रेरित हुनको निम्ति बोलाइएका र सुसमाचारको कामको निम्ति अलग गरिएका, येशू ख्रीष्‍टका दास पावल ।
EOT
)" 'search' 'येशू ख्रीष्‍ट' '--book' 'romans' 'in' 'npiulb'
Add_Test 'NPIULB' 'search येशू ख्रीष्‍ट in npiulb --book romans --chapter 2' "$(cat <<'EOT'
...
EOT
)" 'search' 'येशू ख्रीष्‍ट' 'in' 'npiulb' '--book' 'romans' '--chapter' '2'
Add_Test 'NPIULB' 'search येशू ख्रीष्‍ट in npiulb --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
...
EOT
)" 'search' 'येशू ख्रीष्‍ट' 'in' 'npiulb' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'ABTAG' 'search Jesucristo --book romans in abtag' \
  'MGA TAGA ROMA 1:1 Si Pablo na alipin ni Jesucristo, na tinawag na maging apostol, ibinukod sa evangelio ng Dios,' \
  'search' 'Jesucristo' '--book' 'romans' 'in' 'abtag'
Add_Test 'ABTAG' 'search Jesucristo in abtag --book romans --chapter 2' \
  ...
  'search' 'Jesucristo' 'in' 'abtag' '--book' 'romans' '--chapter' '2'
Add_Test 'ABTAG' 'search Jesucristo in abtag --book romans --chapter 3 --end-chapter 5' \
  ...
  'search' 'Jesucristo' 'in' 'abtag' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'KTTV' 'search Đức Chúa Jêsus Christ --book romans in kttv' "$(cat <<'EOT'
Rô-ma 1:1 Phao-lô, tôi-tớ của Đức Chúa Jêsus-Christ, được gọi làm sứ-đồ, để riêng ra đặng giảng Tin-lành Đức Chúa Trời, —
EOT
)" 'search' 'Đức Chúa Jêsus Christ' '--book' 'romans' 'in' 'kttv'
Add_Test 'KTTV' 'search Đức Chúa Jêsus Christ in kttv --book romans --chapter 2' "$(cat <<'EOT'
...
EOT
)" 'search' 'Đức Chúa Jêsus Christ' 'in' 'kttv' '--book' 'romans' '--chapter' '2'
Add_Test 'KTTV' 'search Đức Chúa Jêsus Christ in kttv --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
...
EOT
)" 'search' 'Đức Chúa Jêsus Christ' 'in' 'kttv' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'IRVGUJ' 'search ઈસુ ખ્રિસ્ત --book romans in irvguj' "$(cat <<'EOT'
...
EOT
)" 'search' 'ઈસુ ખ્રિસ્ત' '--book' 'romans' 'in' 'irvguj'
Add_Test 'IRVGUJ' 'search ઈસુ ખ્રિસ્ત in irvguj --book romans --chapter 2' "$(cat <<'EOT'
રોમ. 2:16 ઈશ્વર મારી સુવાર્તા પ્રમાણે ઈસુ ખ્રિસ્તની મારફતે મનુષ્યોના ગુપ્ત કામોનો ન્યાય કરશે, તે દિવસે એમ થશે.
EOT
)" 'search' 'ઈસુ ખ્રિસ્ત' 'in' 'irvguj' '--book' 'romans' '--chapter' '2'
Add_Test 'IRVGUJ' 'search ઈસુ ખ્રિસ્ત in irvguj --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
...
EOT
)" 'search' 'ઈસુ ખ્રિસ્ત' 'in' 'irvguj' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'IRVMAR' 'search येशू ख्रिस्त --book romans in irvmar' "$(cat <<'EOT'
रोम. 1:1 प्रेषित होण्यास बोलावलेला, येशू ख्रिस्ताचा दास, देवाच्या सुवार्तेसाठी वेगळा केलेला, पौल ह्याजकडून;
EOT
)" 'search' 'येशू ख्रिस्त' '--book' 'romans' 'in' 'irvmar'
Add_Test 'IRVMAR' 'search येशू ख्रिस्त in irvmar --book romans --chapter 2' "$(cat <<'EOT'
...
EOT
)" 'search' 'येशू ख्रिस्त' 'in' 'irvmar' '--book' 'romans' '--chapter' '2'
Add_Test 'IRVMAR' 'search येशू ख्रिस्त in irvmar --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
...
EOT
)" 'search' 'येशू ख्रिस्त' 'in' 'irvmar' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'IRVTEL' 'search యేసు క్రీస్తు --book romans in irvtel' "$(cat <<'EOT'
రోమా పత్రిక 1:1 యేసు క్రీస్తు దాసుడు, అపోస్తలుడుగా పిలుపు పొందినవాడు, దేవుని సువార్త కోసం ప్రభువు ప్రత్యేకించుకున్న
EOT
)" 'search' 'యేసు క్రీస్తు' '--book' 'romans' 'in' 'irvtel'
Add_Test 'IRVTEL' 'search యేసు క్రీస్తు in irvtel --book romans --chapter 2' "$(cat <<'EOT'
రోమా పత్రిక 2:16 నా సువార్త ప్రకారం దేవుడు యేసు క్రీస్తు ద్వారా మానవుల రహస్యాలను విచారించే రోజున ఈ విధంగా జరుగుతుంది.
EOT
)" 'search' 'యేసు క్రీస్తు' 'in' 'irvtel' '--book' 'romans' '--chapter' '2'
Add_Test 'IRVTEL' 'search యేసు క్రీస్తు in irvtel --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
రోమా పత్రిక 3:22 అది యేసు క్రీస్తులో విశ్వాసమూలంగా నమ్మే వారందరికీ కలిగే దేవుని నీతి.
EOT
)" 'search' 'యేసు క్రీస్తు' 'in' 'irvtel' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
...
Add_Test 'IRVURD' 'search ईसा मसीह --book romans in irvurd' "$(cat <<'EOT'
...
EOT
)" 'search' 'ईसा मसीह' '--book' 'romans' 'in' 'irvurd'
Add_Test 'IRVURD' 'search ईसा मसीह in irvurd --book romans --chapter 2' "$(cat <<'EOT'
...
EOT
)" 'search' 'ईसा मसीह' 'in' 'irvurd' '--book' 'romans' '--chapter' '2'
Add_Test 'IRVURD' 'search ईसा मसीह in irvurd --book romans --chapter 3 --end-chapter 5' "$(cat <<'EOT'
...
EOT
)" 'search' 'ईसा मसीह' 'in' 'irvurd' '--book' 'romans' '--chapter' '3' '--end-chapter' '5'
