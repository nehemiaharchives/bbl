...
### 3. Bible reading specifying translation
  ...
  * 2.4. bbl $bookName $chapter in $translation1 $translation2 $translation3... (NEW) : DONE
  * 2.5. bbl $bookName $chapter:$startVerse in $translation1 $translation2 $translation3... (NEW) : DONE
  * 2.6. bbl $bookName $chapter:$startVerse-$endVerse in $translation1 $translation2 $translation3... (NEW) : DONE
...
### 4. Random bible
  ...
  * 4.5. bbl rand $category (abraham, david, prophets, paul, john etc, NEW) : DONE
