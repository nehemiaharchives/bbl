...
data class Language(
     ...
     * Context of use, this code is used internally in the bbl code but also used as command line argument to specify language in the bbl command line tool.
    ...
    val searchModuleId: SearchModuleId = SearchModuleId.COMMON,
){
    ...
    companion object {
        ...
        val ru = Language(
            ...
            nativeName = "Русский",
            order = WESTERN + 6,
            bookNamesConcat =  "Бытие|Исход|Левит|Числа|Второзаконие|Иисус Навин|Судьи|Руфь|1 Царств|2 Царств|3 Царств|4 Царств|1 Паралипоменон|2 Паралипоменон|Ездра|Неемия|Есфирь|Иов|Псалтирь|Притчи|Екклесиаст|Песнь песней|Исаия|Иеремия|Плач Иеремии|Иезекииль|Даниил|Осия|Иоиль|Амос|Авдий|Иона|Михей|Наум|Аввакум|Софония|Аггей|Захария|Малахия|Матфей|Марк|Лука|Иоанн|Деяния|Римлянам|1 Коринфянам|2 Коринфянам|Галатам|Ефесянам|Филиппийцам|Колоссянам|1 Фессалоникийцам|2 Фессалоникийцам|1 Тимофею|2 Тимофею|Титу|Филимону|Евреям|Иаков|1 Петра|2 Петра|1 Иоанна|2 Иоанна|3 Иоанна|Иуда|Откровение",
        )
        ...
        val nl = Language(
            ...
            order = WESTERN + 7,
            bookNamesConcat = "Genesis|Exodus|Leviticus|Numeri|Deuteronomium|Jozua|Rechters|Ruth|1 Samuël|2 Samuël|1 Koningen|2 Koningen|1 Kronieken|2 Kronieken|Ezra|Nehemia|Ester|Job|Psalmen|Spreuken|Prediker|Hooglied|Jesaja|Jeremia|Klaagliederen|Ezechiël|Daniël|Hosea|Joël|Amos|Obadja|Jona|Micha|Nahum|Habakuk|Sefanja|Haggaï|Zacharia|Maleachi|Matteüs|Marcus|Lucas|Johannes|Handelingen|Romeinen|1 Korintiërs|2 Korintiërs|Galaten|Efeziërs|Filippenzen|Kolossenzen|1 Tessalonicenzen|2 Tessalonicenzen|1 Timoteüs|2 Timoteüs|Titus|Filemon|Hebreeën|Jakobus|1 Petrus|2 Petrus|1 Johannes|2 Johannes|3 Johannes|Judas|Openbaring",
        )
        ...
        val pl = Language(
            ...
            searchModuleId = SearchModuleId.MORFOLOGIK,
        )
        ...
        val zh = Language(
            ...
            searchModuleId = SearchModuleId.SMARTCN,
        )
        ...
        val ko = Language(
            ...
            searchModuleId = SearchModuleId.NORI,
        )
        ...
        val ja = Language(
            ...
            searchModuleId = SearchModuleId.KUROMOJI,
        )
